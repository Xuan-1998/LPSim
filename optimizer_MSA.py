...
SCENARIOS = [
    {
        ...
        "LEARNING_RATE": 0.6072940840032456,
        "MAX_TOLL_CHANGE": 13.306072730364498,
        'INERTIA': 0.766782183230607
    }
]
...
def run_single_experiment(scenario_name: str, params: dict, max_iterations: int):
    ...
    # --- NEW: Create a dedicated subdirectory for temporary toll files ---
    ...
    for i in range(max_iterations):
        ...
        # --- MODIFIED: Save the toll file to its new, organized location ---
        # This will create a path like "results_Best_Params/temp_tolls/tolls_for_iter_0.csv"
        ...
        # --- MODIFIED: Calculate the relative path for the simulator's INI file ---
        # The simulator runs from inside "LivingCity", so it needs a path like
        # "../results_Best_Params/temp_tolls/tolls_for_iter_0.csv"
        ...
        # --- MODIFIED: Pass the new relative path to the INI updater ---
